...
import { CoworkerConfig } from "../../models";
...
export class CoworkerConfigurationComponent implements PluginConfigurationComponent, OnInit, OnDestroy {
  ...
  @Input() prefillConfiguration$!: Observable<CoworkerConfig>;
  @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() configuration: EventEmitter<PluginConfigurationData> = new EventEmitter<PluginConfigurationData>();

  private saveSubscription!: Subscription;
  private readonly formValue$ = new BehaviorSubject<CoworkerConfig | null>(null);
  ...
  formValueChange(formValue: CoworkerConfig): void {
  ...
  private handleValid(formValue: CoworkerConfig): void {
    ...
    const valid =
      ...
      !!formValue.source &&
      !!formValue.requestQueue &&
      !!formValue.replyQueue;
